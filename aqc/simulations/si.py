...
class SISimulation(Simulation):
  ...
  def process(self, output, propagation_step):
    I_0 = abs(output[self.channel.grid.origin_index[0], self.channel.grid.origin_index[1]])**2
...
class SISimulationGUI(SISimulation, SimulationGUI):  
  def print(self):
